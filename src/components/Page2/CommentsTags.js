    ...
    <div className={classes.container}>
      <div className={classes.comments}>
        ...
        <div className={classes.comments2}>
          ...
          <p className={classes.prevCommentsNum}>4</p>
        </div>
      </div>

      <div className={classes.heroComments}>
        <div className={classes.wrapperComments}>
          <div className={classes.inputCommentsCenter}>
            <input
              type="text"
          ...
          <div className={classes.wrapper2}>
            <div className={classes.heroTags}>
              <div className={classes.heroTags1}>
                ...
                >
                  Birthday {select3 ? <span>X</span> : null}
                </p>
                <p
                  className={
              ...
              <div className={classes.heroTags1}>
                ...
                >
                  Booth Requested {select6 ? <span>X</span> : null}
                </p>
                <p
                  className={
                ...
                >
                  Patio Requested {select7 ? <span>X</span> : null}
                </p>
                <p
                  className={select8 ? classes.QuiteTable : classes.QuiteTable1}
                  onClick={TagsSelectHandler8}
                >
                  Quite Table {select8 ? <span>X</span> : null}
                </p>
                <p
                  className={
                    select9
                ...
                >
                  Special occasions {!select9 ? <span>X</span> : null}
                </p>
                <p
                  className={
                ...
                >
                  Graduation{!select10 ? <span>X</span> : null}
                </p>
              </div>
            </div>
          </div>
